        ...
        <section className="px-6 py-20 max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h1 className="text-6xl md:text-7xl font-bold tracking-tight text-primary leading-[1.1] mb-8">
              Built For Modern <span className="text-secondary">African</span> Schools
            </h1>
            <p className="text-xl text-on-surface-variant leading-relaxed mb-10 max-w-xl">
              Experience the operating system that unifies administration, finance, and learning. Reduce manual workload by 70% while providing unparalleled transparency for parents and staff.
            </p>
            <div className="flex flex-wrap gap-4">
              ...
              <div className="flex items-center gap-4 px-4 py-2 bg-surface-container-low rounded-xl">
                <span className="text-sm font-semibold text-primary">Used by 12,000+ Educators</span>
              </div>
            </div>
          </div>
          <div className="relative group">
            ...
            <div className="relative bg-surface-container-low rounded-[2rem] p-10 flex items-center justify-center min-h-[400px] border border-outline-variant/20 shadow-2xl">
              <div className="text-center">
                ...
                <div className="mt-4 text-2xl font-bold text-primary/40">Trusted Platform</div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="px-6 py-24 bg-surface-container-low">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold text-primary mb-4 tracking-tight">Engineered for Every Level</h2>
              <p className="text-on-surface-variant max-w-2xl mx-auto text-lg">
                Whether you are nurturing toddlers or awarding degrees, School OS adapts to your institutional workflow.
              </p>
            </div>
            <div className="grid md:grid-cols-4 gap-6">
              {[
                { icon: 'child_care', title: 'Primary Schools', desc: 'Streamline parent communication and early literacy tracking.' },
                { icon: 'school', title: 'Secondary Schools', desc: 'Manage complex grading and career path tracking.' },
                { icon: 'account_balance', title: 'Universities', desc: 'Scalable modules for research and course registration.' },
                { icon: 'workspace_premium', title: 'Training Centers', desc: 'Short-course certificates and vocational tracking.' },
              ].map((item, i) => (
                <div
                  key={i}
            ...
            <div className="grid lg:grid-cols-2 gap-20 items-center">
              <div className="bg-surface-container-lowest/10 backdrop-blur-md p-10 rounded-[2.5rem] border border-white/10 shadow-2xl flex items-center justify-center min-h-[350px]">
                <div className="text-center">
                  ...
                  <div className="mt-2 text-xl font-bold text-white/30">Analytics Dashboard</div>
                </div>
              </div>
              <div>
                <h2 className="text-4xl md:text-5xl font-bold mb-8 leading-tight tracking-tight">Data That Drives Growth</h2>
                <div className="space-y-8">
                  <div className="flex gap-6">
                    ...
                    <div>
                      ...
                      <p className="text-white/70">Visualize student progress over terms with AI-powered trend analysis to identify students needing help.</p>
                    </div>
                  </div>
                  <div className="flex gap-6">
                    <div className="w-14 h-14 shrink-0 bg-white/10 rounded-2xl flex items-center justify-center">
                    ...
                    <div>
                      <h4 className="text-xl font-bold mb-2">Revenue Forecasts</h4>
                      <p className="text-white/70">Predict upcoming cash flows based on billing cycles and collection history with 95% precision.</p>
                    </div>
                  </div>
                  <div className="flex gap-6">
                    <div className="w-14 h-14 shrink-0 bg-white/10 rounded-2xl flex items-center justify-center">
                    ...
                    <div>
                      <h4 className="text-xl font-bold mb-2">One-Click Reports</h4>
                      <p className="text-white/70">Export detailed compliance, academic, and financial reports in PDF or Excel format instantly.</p>
                    </div>
                  </div>
                </div>
              </div>
