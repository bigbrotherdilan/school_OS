    ...
    <div className="min-h-screen bg-surface flex flex-col items-center justify-center px-4 py-10">
      <div className="w-full max-w-md">
        <div className="mb-6 text-center">
          ...
          <p className="text-sm text-on-surface-variant mt-1">Secure your account</p>
        </div>

        <div className="flex items-start gap-3 p-4 mb-4 bg-amber-50 border border-amber-200 rounded-2xl">
          <ShieldAlert className="w-5 h-5 text-amber-600 shrink-0 mt-0.5" />
          <div>
            <p className="text-sm font-bold text-amber-800">Temporary password detected</p>
            <p className="text-xs text-amber-700 mt-1">
              For your security, you must create a new password before you can access your portal.
            </p>
          </div>
        </div>
