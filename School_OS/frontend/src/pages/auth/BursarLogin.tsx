    ...
    return (
        <div className="min-h-screen bg-slate-50 flex flex-col justify-center items-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
            ...
            <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10 text-center mb-8">
                ...
                <h2 className="text-3xl font-extrabold text-slate-900 tracking-tight">Bursar Portal</h2>
                <p className="mt-2 text-sm text-slate-500 font-medium">Fees, payments, and financial records.</p>
            </div>
            ...
            <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
                <div className="bg-white py-10 px-6 sm:px-10 rounded-3xl shadow-xl border border-slate-200 relative overflow-hidden">
                    ...
                    <form className="space-y-6" onSubmit={handleLogin}>
                        <div>
                            <label className="block text-sm font-semibold text-slate-700 mb-1">Bursar Email</label>
