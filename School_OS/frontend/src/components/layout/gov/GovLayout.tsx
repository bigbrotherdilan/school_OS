                ...
                <div className="flex justify-between items-center w-full px-4 lg:px-6 py-3 max-w-[1920px] mx-auto font-['Public_Sans'] antialiased tracking-tight">
                    <div className="flex items-center gap-4 lg:gap-8">
                        ...
                        <nav className="hidden md:flex items-center gap-6">
                            <NavLink to="/gov" end className={({isActive}) => isActive ? "text-primary font-bold border-b-2 border-primary pb-2" : "text-slate-600 font-medium hover:text-primary transition-colors duration-200"}>Overview</NavLink>
                            <NavLink to="/gov/regions" className={({isActive}) => isActive ? "text-primary font-bold border-b-2 border-primary pb-2" : "text-slate-600 font-medium hover:text-primary transition-colors duration-200"}>Regions</NavLink>
                            <NavLink to="/gov/monitoring" className={({isActive}) => isActive ? "text-primary font-bold border-b-2 border-primary pb-2" : "text-slate-600 font-medium hover:text-primary transition-colors duration-200"}>Monitoring</NavLink>
                            <NavLink to="/gov/compliance" className={({isActive}) => isActive ? "text-primary font-bold border-b-2 border-primary pb-2" : "text-slate-600 font-medium hover:text-primary transition-colors duration-200"}>Inspections</NavLink>
                        </nav>
                    </div>
                    <div className="flex items-center gap-4">
                        <div className="relative hidden lg:block">
                            <span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-outline">search</span>
                            <input className="pl-10 pr-4 py-2 bg-surface-container-low border-none rounded-md text-sm w-64 focus:ring-2 focus:ring-primary" placeholder="Search national records..." type="text" />
                        </div>
                ...
                <aside className={`fixed left-0 top-16 h-[calc(100vh-64px)] z-50 flex-col pt-8 bg-slate-50 w-64 border-r border-transparent transition-transform duration-300 ${
                    ...
                    <div className="px-6 mb-8">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h2 className="font-bold text-primary text-sm uppercase tracking-wider">Control Panel</h2>
                                <p className="text-[10px] text-slate-500 font-medium">National Education</p>
                            </div>
                        </div>
                    </div>
                    <nav className="flex-1 px-4 space-y-1">
                        <NavLink onClick={() => setIsSidebarOpen(false)} to="/gov/alerts" className="flex items-center gap-3 px-4 py-3 text-slate-500 hover:bg-slate-100 hover:translate-x-1 transition-all duration-150 rounded-md">
                            ...
                            <span className="font-['Public_Sans'] text-sm tracking-wide">Alerts</span>
                        </NavLink>
                        <NavLink onClick={() => setIsSidebarOpen(false)} to="/gov/inspections" className="flex items-center gap-3 px-4 py-3 text-slate-500 hover:bg-slate-100 hover:translate-x-1 transition-all duration-150 rounded-md">
                            ...
                            <span className="font-['Public_Sans'] text-sm tracking-wide">Inspections</span>
                        </NavLink>
                        <NavLink onClick={() => setIsSidebarOpen(false)} to="/gov/policy" className="flex items-center gap-3 px-4 py-3 text-slate-500 hover:bg-slate-100 hover:translate-x-1 transition-all duration-150 rounded-md">
                            ...
                            <span className="font-['Public_Sans'] text-sm tracking-wide">Policy</span>
                        </NavLink>
                        <NavLink onClick={() => setIsSidebarOpen(false)} to="/gov/support" className="flex items-center gap-3 px-4 py-3 text-slate-500 hover:bg-slate-100 hover:translate-x-1 transition-all duration-150 rounded-md">
                            ...
                            <span className="font-['Public_Sans'] text-sm tracking-wide">Support</span>
                        </NavLink>
                    </nav>
                    <div className="p-6 mt-auto">
                        <div className="bg-primary-container p-4 rounded-lg">
                            <p className="text-on-primary-container text-xs font-bold mb-1">System Health</p>
                            ...
                            <p className="text-[10px] text-on-primary-container/80 mt-2">All nodes operational</p>
                        </div>
                    </div>
                </aside>
